...
/**
 * Create a victory screen with a "Play Again?" button and a "Quit?" button.
 * This is the
 * window that will appear shortly after the user defeats the final boss. In
 * order to
 * play the game again the user must press the "Play Again?" button. If they
 * want
